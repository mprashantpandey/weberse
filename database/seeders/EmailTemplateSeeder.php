...
class EmailTemplateSeeder extends Seeder
{
    public function run(): void
    {
        $templates = [
            ...
            [
                'name' => 'Employee Approval Status Update',
                'slug' => 'employee-approval-status-update',
                'category' => 'hr',
                'subject' => '{{item_type}} update: {{status}}',
                'body' => "Hello {{name}},\n\nYour {{item_type}} has been updated.\n\nItem: {{item_title}}\nStatus: {{status}}\nReviewed by: {{reviewed_by}}\nReview note: {{review_note}}\n\nIf you need clarification, reply to the HR team.\n\nRegards,\nWeberse HR Team",
                'description' => 'Sent to employees when a leave, expense, compensation, or perk request is reviewed.',
                'is_active' => true,
            ],
            [
                'name' => 'HR Daily Approvals Summary',
                'slug' => 'hr-daily-approvals-summary',
                'category' => 'hr',
                'subject' => 'Pending HR approvals for {{date}}',
                'body' => "Hello,\n\nYou have {{total_pending}} pending HR approval items.\n\n{{pending_summary}}\n\nRegards,\nWeberse HR System",
                'description' => 'Daily internal digest for pending HR approvals.',
                'is_active' => true,
            ],
            [

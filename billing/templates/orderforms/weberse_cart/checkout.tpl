...
<div id="order-weberse_cart">
    ...
    <div class="row">
        ...
        <div class="cart-body">
            ...
            {include file="orderforms/weberse_cart/includes/stepper.tpl" step="checkout"}
            ...
            <form method="post" action="{$smarty.server.PHP_SELF}?a=checkout" name="orderfrm" id="frmCheckout">
                ...
                <div id="containerExistingUserSignin"{if $loggedin || $custtype neq "existing"} class="w-hidden{/if}">
                    ...
                    {include file="orderforms/weberse_cart/linkedaccounts.tpl" linkContext="checkout-existing"}
                </div>
                ...
                >
                    ...
                    <div{if $loggedin} class="w-hidden"{/if}>
                        {include file="orderforms/weberse_cart/linkedaccounts.tpl" linkContext="checkout-new"}
                    </div>
                    ...
                    <div class="cc-input-container{if $selectedgatewaytype neq "CC"} w-hidden{/if}" id="creditCardInputFields">
                        {if $client}
                            <div id="existingCardsContainer" class="existing-cc-grid">
                                {include file="orderforms/weberse_cart/includes/existing-paymethods.tpl"}
                            </div>
                        {/if}

...
{else}
    ...
    {include file="orderforms/weberse_cart/common.tpl"}
    <script type="text/javascript" src="{$BASE_PATH_JS}/StatesDropdown.js"></script>

    <div id="order-weberse_cart" class="weberse-cart-view">

        <div class="row">
            <div class="cart-sidebar">

                {include file="orderforms/weberse_cart/sidebar-categories.tpl"}
            ...
            {include file="orderforms/weberse_cart/includes/stepper.tpl" step="review"}
                {include file="orderforms/weberse_cart/sidebar-categories-collapsed.tpl"}

                <div class="row">
                    <div class="secondary-cart-body">

                        {if $cartitems == 0}
                            <div class="weberse-empty-cart">
                                <div class="weberse-empty-ico">
                                    <i class="far fa-bag-shopping"></i>
                                </div>
                                <h3>Your cart is empty</h3>
                                <p>Add a hosting plan or register a domain to continue.</p>
                                <div class="weberse-empty-actions">
                                    <a class="btn btn-primary" href="{$WEB_ROOT}/cart.php">Browse Plans</a>
                                    <a class="btn btn-default" href="{$WEB_ROOT}/cart.php?a=add&domain=register">Search Domain</a>
                                </div>
                            </div>
                        {else}
    ...
    {include file="orderforms/weberse_cart/recommendations-modal.tpl"}
{/if}

        ...
        <aside class="weberse-auth-sidebar">
            <div class="weberse-auth-sidebar-card">
                ...
                <div class="weberse-auth-sidebar-links">
                    <a class="weberse-auth-sidebar-link" href="{routePath('login')}">
                        <i class="far fa-right-to-bracket"></i>
                        Sign in
                    </a>
                    <a class="weberse-auth-sidebar-link" href="{routePath('password-reset-begin')}">
                        <i class="far fa-key"></i>
                        Reset password
                    </a>
                    <a class="weberse-auth-sidebar-link" href="{$WEB_ROOT}/cart.php">
                        <i class="far fa-bag-shopping"></i>
                        Browse plans
                    </a>
                    <a class="weberse-auth-sidebar-link" href="{$WEB_ROOT}/clientarea.php">
                                ...
                                <div class="weberse-auth-section card mb-4">
                                    <div class="card-body p-4" id="personalInformation">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                {* Phone field uses country selector; no left icon to avoid overlap *}

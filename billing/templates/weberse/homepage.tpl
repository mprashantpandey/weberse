{* Weberse WHMCS Homepage - Hosting landing page *}
    ...
    <div class="weberse-home-hero-inner">
        <div class="weberse-home-hero-copy">
            ...
            <div class="weberse-home-cta">
                <a class="btn btn-primary" href="{$WEB_ROOT}/cart.php">Check Plans</a>
                <a class="btn btn-default" href="{$WEB_ROOT}/clientarea.php{if !$loggedin}?rp=/login{/if}">Client Area</a>
            </div>
        </div>
...
<section class="weberse-home-section weberse-home-domain-band">
    ...
    <div class="weberse-home-split">
        <div class="weberse-home-split-card">
            ...
            <form method="post" action="{$WEB_ROOT}/domainchecker.php" class="weberse-domain-search" id="weberseDomainSearch">
        ...
        <div class="weberse-home-split-card">
            ...
            <div class="weberse-home-cta">
                <a class="btn btn-primary" href="{routePath('domain-pricing')}">Domain pricing</a>
                <a class="btn btn-default" href="{$WEB_ROOT}/cart.php?a=add&domain=register">Register</a>
            </div>
        </div>
    </div>
</section>
    ...
    <section class="weberse-home-section">
        ...
        <div class="weberse-plan-grid">
            {foreach $productGroups as $productGroup}
                <a class="weberse-plan-card" href="{$productGroup->getRoutePath()}">
                    <div class="weberse-plan-top">
                        <div class="weberse-plan-name">{$productGroup->name}</div>
                        {if $productGroup->tagline}<div class="weberse-plan-tagline">{$productGroup->tagline}</div>{/if}
                    </div>

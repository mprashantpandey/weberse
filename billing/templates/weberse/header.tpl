...
<body class="primary-bg-color weberse-page-{$templatefile}" data-phone-cc-input="{$phoneNumberInputStyle}">
    ...
    <header id="header" class="header weberse-header">
        ...
        <div class="navbar navbar-light weberse-navbar">
            <div class="container">
                <a class="navbar-brand mr-3 d-flex align-items-center" href="{$WEB_ROOT}/index.php">
                    {if $assetLogoPath}
                        <img src="{$assetLogoPath}" alt="{$companyname}" class="logo-img weberse-logo-img">
                    {else}
                        {$companyname}
                    {/if}
                </a>
                ...
                <ul class="navbar-nav toolbar">
                    <li class="nav-item ml-3">
                        <a class="btn nav-link cart-btn weberse-cart-btn" href="{$WEB_ROOT}/cart.php?a=view">
    ...
    {* Weberse uses a custom landing hero on homepage (includes domain search). *}
    {if $templatefile == 'homepage'}
        {assign var=skipMainBodyContainer value=true}
    {/if}

<?php
/* Smarty version 4.5.3, created on 2026-03-18 10:37:47
  from '/Users/prashant/Desktop/Weberse/billing/templates/weberse/clientregister.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_69ba807b3e8005_09537099',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '483502c4d4db22b79d68439c529032d4fb318a5c' => 
    array (
      0 => '/Users/prashant/Desktop/Weberse/billing/templates/weberse/clientregister.tpl',
      1 => 1773830139,
      2 => 'file',
    ),
  ),
...
function content_69ba807b3e8005_09537099 (Smarty_Internal_Template $_smarty_tpl) {
...
<section class="weberse-auth-shell weberse-auth-register">
    <div class="weberse-auth-grid">
        <aside class="weberse-auth-sidebar">
            <div class="weberse-auth-sidebar-card">
                <div class="weberse-auth-sidebar-head">
                    <div class="weberse-auth-sidebar-title">Already registered?</div>
                    <div class="weberse-auth-sidebar-sub">Use these quick links.</div>
                </div>

                <div class="weberse-auth-sidebar-links">
                    <a class="weberse-auth-sidebar-link" href="<?php echo routePath('login');?>
">
                        <i class="far fa-right-to-bracket"></i>
                        Sign in
                    </a>
                    <a class="weberse-auth-sidebar-link" href="<?php echo routePath('password-reset-begin');?>
">
                        <i class="far fa-key"></i>
                        Reset password
                    </a>
                    <a class="weberse-auth-sidebar-link" href="<?php echo $_smarty_tpl->tpl_vars['WEB_ROOT']->value;?>
/cart.php">
...
/clientarea.php">
        ...
        <main class="weberse-auth-main">
            <div class="weberse-auth-card">
                <div class="weberse-auth-card-head">
                    <h2>Sign up</h2>
...
?>
                                ...
                                <div class="weberse-auth-section card mb-4">
...
">
                                            ...
                                            <div class="col-sm-6">
                                                                                                <div class="form-group weberse-phone-field">
                                                    <input type="tel" name="phonenumber" id="inputPhone" class="field form-control" placeholder="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['lang'][0], array( array('key'=>'orderForm.phoneNumber'),$_smarty_tpl ) );?>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group prepend-icon">
                                                    ...
                                                    <input type="text" name="companyname" id="inputCompanyName" class="field form-control" placeholder="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['lang'][0], array( array('key'=>'orderForm.companyName'),$_smarty_tpl ) );?>
...
"  <?php if (!in_array('address1',$_smarty_tpl->tpl_vars['optionalFields']->value)) {?>required<?php }?>>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group prepend-icon">
                                                    ...
                                                    <input type="text" name="address2" id="inputAddress2" class="field form-control" placeholder="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['lang'][0], array( array('key'=>'orderForm.streetAddress2'),$_smarty_tpl ) );?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                ...
                                <?php if ((isset($_smarty_tpl->tpl_vars['accountDetailsExtraFields']->value)) && !empty($_smarty_tpl->tpl_vars['accountDetailsExtraFields']->value)) {?>
                                    <div class="weberse-auth-section card mb-4">
                                        <div class="card-body p-4">
                                            <h3 class="card-title"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['lang'][0], array( array('key'=>'orderForm.additionalInformation'),$_smarty_tpl ) );?>
</h3>
                                            <div class="row">
                                                <?php
...
" class="field form-control" placeholder="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['lang'][0], array( array('key'=>'clientareapassword'),$_smarty_tpl ) );?>
...
"<?php }?>>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group prepend-icon">
                                                    ...
                                                    <input type="password" name="password2" id="inputNewPassword2" class="field form-control" placeholder="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['lang'][0], array( array('key'=>'clientareaconfirmpassword'),$_smarty_tpl ) );?>
" autocomplete="off"<?php if ($_smarty_tpl->tpl_vars['remote_auth_prelinked']->value) {?> value="<?php echo $_smarty_tpl->tpl_vars['password']->value;?>
"<?php }?>>
                                                </div>
                                            </div>
...
"/>
                ...
                <div class="weberse-auth-card-foot">
                    <span>Already have an account?</span>
                    <a href="<?php echo routePath('login');?>
">Sign in</a>
                </div>
            </div>
        </main>
